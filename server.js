...
//Ensure folder exists when app loads
...
app.get('/', async (req, res) => {
  ...
  //Generate HTML to insert into Homepage.
  const generatedHTML = ReactDOMServer.renderToString(
    <div className="container">
      <div className="animal-grid mb-3">
        {!allAnimals.length && <h1>Please login to create an animal!</h1>}
      ...
      <p><a href="/admin">Login to manage listings.</a></p>
    </div>
  )
...
//Hoisted function to control user input
